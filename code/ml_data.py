...
ml698pd = (
    {
        'range': (60809.611162, 60809.7088483), 'param': '698volt', 'xs': [60.25, 157.4],  # [0.5, 0.4]
        'err': 1.5e-16*429e12, 'dy': -3.4*4,
    }, # 0   
    {
        'range': (60809.7088483, 60809.83), 'param': '698volt', 'xs': [60, 31.2],  # [0.5, 0.35]
        'err': 1e-16*429e12, 'dy': 1.1*4,
    }, # 1
    {
        'range': (60809.7088483, 60809.83), 'param': '698volt', 'xs': [60, 140],  # [0.5, 0.35]
        'err': 1e-16*429e12, 'dy': -3*4,
    }, # 1
)
