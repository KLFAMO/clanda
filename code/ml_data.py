...
ml698pd = (
    {
        'range': (60809.611162, 60809.7088483), 'param': '698volt', 'xs': [61, 159],  # [0.5, 0.4]
        'err': 1.5e-16*429e12, 'dy': -3.5,
    }, # 0   
    {
        'range': (60809.7088483, 60809.83), 'param': '698volt', 'xs': [61, 31],  # [0.5, 0.35]
        'err': 1e-16*429e12, 'dy': 1.5,
    }, # 1
)
