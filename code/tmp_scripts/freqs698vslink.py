...
gts.math_mts_and_number('add', 'comb2_f_avg_counter7', nc_rls+ptb_freq-70e6+14e6, 'f_ule15')
N15 = 777_621
...
gts.append_mtserie(
    mts_name='rfsrc',
    mts=gts.mts_dict['fsrc'].resample(period_s=600)
)
...
gts.mts_dict['fsrc'].rm_drift()
gts.mts_dict['rfsrc'].rm_drift()
gts.mts_dict['rfsrc'].plot()
gts.mts_dict['fsrc'].plot_allan(atom='88Sr', rate=1, allan_method='adev')
