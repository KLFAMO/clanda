...
# cor_mjd = [
#     60751,   60753,   60753.9426,   60754.,  60755,   60763.9,      60764.5749, 60765.45, 60766
# ]
# cor_val = [
#     263.798, 263.798, 99.078,       99.078,  99.078,  99.078-1.2,     44.566,       44.566,    44.566,
# ] 
...
included_tables = {
    ...
    # "sr1_ml2_probL",
    # "sr1_ml2_atomsL",
    # "wm_813_f": {'sh_s':0, 'tol_s':600},
    "comb2_f_avg_counter0": {'sh_s':0.05, 'tol_s':0},
    # "comb2_f_avg_counter3",
